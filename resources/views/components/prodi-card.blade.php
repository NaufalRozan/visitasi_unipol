<div
    ...
    <div class="relative mb-4 rounded-2xl">
        ...
        <div class="flex justify-center items-center bg-green-600 bg-opacity-80 z-10 absolute top-0 left-0 w-full h-full text-white rounded-2xl opacity-0 transition-all duration-300 transform group-hover:scale-105 text-xl group-hover:opacity-100"
    ...
    <h3 class="font-medium text-xl leading-8">
        <a href="javascript:void(0);" onclick="openModal({{ $prodi->id }})"
            class="block relative group-hover:text-green-600 transition-colors duration-200 ">
            {{ $prodi->nama_sub_unit }}
        </a>
    </h3>
</div>
